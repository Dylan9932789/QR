...
<body>
    ...
    <label for="errorCorrectionLevel">Уровень коррекции ошибок:</label>
    ...
    <script>
        function generateVideoQR() {
            ...
            var qr = qrcode(errorCorrectionLevel, 'M');
    ...
    <footer>
        <p>&copy; 2024 Разработчик Дилан933. Все права защищены. г.Вяземский| </p>    
    </footer>
